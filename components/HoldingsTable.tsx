            ...
            {holdings.map((holding) => {
              ...
              return [
                  <tr className="border-t border-ink/10 even:bg-paper/50 hover:bg-mint/20" key={`${holding.id}-summary`}>
                    ...
                    <td className="px-2 py-2 sm:px-3 sm:py-3">{current ? formatMoney(current.grossValue, currency) : "N/A"}</td>
                    <td className={`bg-marine/5 px-2 py-2 font-semibold sm:px-3 sm:py-3 ${valueClass(current?.profitLoss)}`}>{current ? `${formatMoney(current.profitLoss, currency)} (${current.profitLossPercent}%)` : "N/A"}</td>
                    ...
                    <td className="border-l-2 border-ink/15 bg-amber/10 px-2 py-2 font-semibold sm:px-3 sm:py-3">{stopPrice ? formatMoney(stopPrice, currency) : "N/A"}</td>
                    <td className="px-2 py-2 sm:px-3 sm:py-3">{stopPl ? `${formatMoney(stopPl.profitLoss, currency)} (${stopPl.profitLossPercent}%)` : "N/A"}</td>
                    <td className="border-l-2 border-ink/15 bg-mint/70 px-2 py-2 font-bold text-marine sm:px-3 sm:py-3">{targetPrice ? formatMoney(targetPrice, currency) : "N/A"}</td>
